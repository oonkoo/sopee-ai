// components/letters/AustraliaLettersClient.tsx
'use client'
...
interface AustraliaLettersClientProps {
  initialLetters: GeneratedLetter[]
  user: User
}

export default function AustraliaLettersClient({ initialLetters, user }: AustraliaLettersClientProps) {
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-primary/10 border border-primary/20 p-4">
                <Image 
              ...
              <div>
                <h1 className="text-3xl font-bold">Australia Letters</h1>
                <p className="text-muted-foreground">
                  Your generated statements and documents for Australian visa applications
                </p>
              </div>
            </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-primary/80">Total Generated</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="text-center py-12 border-border/50 bg-card/50">
              <CardContent>
                <div className="max-w-md mx-auto space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Generate your first Statement of Purpose for Australian visa applications using our AI-powered service.
                  </p>
                  <Link href="/australia/letters/generate">
                    <Button size="lg" className="gap-2 bg-primary hover:bg-primary/90" disabled={remainingLetters <= 0}>
                      <Plus className="h-5 w-5" />
