// app/australia/letters/generate/page.tsx
...
export default async function AustraliaGeneratePage() {
  ...
  let profile = null
  try {
    profile = await ProfileService.getUserProfile(user.id, 'AUSTRALIA')
  } catch {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold mb-2">Generate Your Australian Statement of Purpose</h1>
            <p className="text-muted-foreground">
              Create a professional SOP using AI trained on approved Australian visa applications
            </p>
          </div>
