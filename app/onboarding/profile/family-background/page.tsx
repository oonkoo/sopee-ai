// app/onboarding/profile/family-background/page.tsx
import { getKindeServerSession } from '@kinde-oss/kinde-auth-nextjs/server'
import { redirect } from 'next/navigation'
import { getCurrentUser } from '@/lib/kinde'
import { ProfileService } from '@/lib/services/profileService'
import FamilyBackgroundForm from '@/components/onboarding/FamilyBackgroundForm'

export default async function FamilyBackgroundPage() {
